...
from hermes_cli.subcommands.evals import build_eval_parser
...
_BUILTIN_SUBCOMMANDS = frozenset(
    {
        ...
        "dump", "eval", "fallback", "gateway", "hooks", "import", "insights",
...
def main():
    ...
    # =========================================================================
    # eval command  (parser built in hermes_cli/subcommands/evals.py)
    # =========================================================================
