...
def skill_view(
    ...
    try:
        ...
        if len(candidates) > 1:
            # Tool responses use stable POSIX separators on every host.  This
            # keeps categorized skill paths portable for agents and callers
            # instead of leaking Windows-only backslashes into the protocol.
