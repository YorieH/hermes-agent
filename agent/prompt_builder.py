...
KANBAN_GUIDANCE = (
    ...
    "## Lifecycle\n"
    "\n"
    "1. **Orient.** Call `kanban_show()` first (no args). Treat its title/body, "
    "parent handoffs, prior attempts, comments, and `worker_context` as ground "
    "truth.\n"
    ...
    "For `Coordinator review/unblock:` tasks, inspect the review and original "
    "cards. Finish only after unblocking or completing the original, or block "
    "with its remaining human-only decision.\n"
    "\n"
